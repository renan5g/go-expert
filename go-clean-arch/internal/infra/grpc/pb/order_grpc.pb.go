...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Black, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Black, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Black) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Black) (*OrderList, error) {
...
func _OrderService_ListOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrders(ctx, req.(*Black))
	}
	return interceptor(ctx, in, info, handler)
}
