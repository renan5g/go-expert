...
import (
	...
	"github.com/renan5g/go-uow/internal/db"
	"github.com/renan5g/go-uow/internal/repository"
	"github.com/renan5g/go-uow/pkg/uow"
...
func TestAddCourseUow(t *testing.T) {
	dbt, err := sql.Open("mysql", "root:password@tcp(localhost:3306)/courses")
